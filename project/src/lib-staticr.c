...
static const u8 fix_51420_pal_bz2[] =
{
  // decompressed size: 0x88 = 136 bytes
  0x00,0x00,0x00,0x88,

  // raw data
  ,
  // 0x88 = 136 data bytes (103%)
};

static BZ2Manager_t fix_51420_pal_mgr
	= { fix_51420_pal_bz2, sizeof(fix_51420_pal_bz2), 0, 0 };

//-----------------------------------------------------------------------------

static const u8 fix_51420_usa_bz2[] =
{
  // decompressed size: 0x88 = 136 bytes
  0x00,0x00,0x00,0x88,

  // raw data
  ,
  // 0x88 = 136 data bytes (103%)
};

static BZ2Manager_t fix_51420_usa_mgr
	= { fix_51420_usa_bz2, sizeof(fix_51420_usa_bz2), 0, 0 };

//-----------------------------------------------------------------------------

static const u8 fix_51420_jap_bz2[] =
{
  // decompressed size: 0x88 = 136 bytes
  0x00,0x00,0x00,0x88,

  // raw data
  ,
  // 0x88 = 136 data bytes (103%)
};

static BZ2Manager_t fix_51420_jap_mgr
	= { fix_51420_jap_bz2, sizeof(fix_51420_jap_bz2), 0, 0 };

//-----------------------------------------------------------------------------

static const u8 fix_51420_kor_bz2[] =
{
  // decompressed size: 0x88 = 136 bytes
  0x00,0x00,0x00,0x88,

  // raw data
  ,
  // 0x88 = 136 data bytes (103%)
};

static BZ2Manager_t fix_51420_kor_mgr
	= { fix_51420_kor_bz2, sizeof(fix_51420_kor_bz2), 0, 0 };

//-----------------------------------------------------------------------------

static BZ2Manager_t * GetFix51420 ( str_mode_t mode )
{
    switch (mode)
    {
	case STR_M_PAL:  return &fix_51420_pal_mgr;
	case STR_M_USA:	 return &fix_51420_usa_mgr;
	case STR_M_JAP:	 return &fix_51420_jap_mgr;
	case STR_M_KOR:  return &fix_51420_kor_mgr;
	default:	 return 0;
    }
}
	...
	( staticr_t *str, ccp fname, u8 **data, uint *size, bool *alloced )
{
    ...
    *alloced = false;
	...
	else if (!strcmp(fname,"@FIX51420"))	wcm = GetFix51420(str->mode);
...
const data_tab_t maindol_data_tab[] =
{
	...
	DEF_BZIP(fix_51420_pal)
	DEF_BZIP(fix_51420_usa)
	DEF_BZIP(fix_51420_jap)
	DEF_BZIP(fix_51420_kor)
 #endif
