...
static const u8 old_lecode_loader_pal_bz2[] =
{
...
static BZ2Manager_t old_lecode_loader_pal_mgr
	= { old_lecode_loader_pal_bz2, sizeof(old_lecode_loader_pal_bz2), 0, 0 };

//-----------------------------------------------------------------------------

static const u8 old_lecode_loader_usa_bz2[] =
{
  // decompressed len: 0x200 = 512 bytes
  0x00,0x00,0x02,0x00,
...
static BZ2Manager_t old_lecode_loader_usa_mgr
	= { old_lecode_loader_usa_bz2, sizeof(old_lecode_loader_usa_bz2), 0, 0 };

//-----------------------------------------------------------------------------

static const u8 old_lecode_loader_jap_bz2[] =
{
  // decompressed len: 0x200 = 512 bytes
  0x00,0x00,0x02,0x00,
...
static BZ2Manager_t old_lecode_loader_jap_mgr
	= { old_lecode_loader_jap_bz2, sizeof(old_lecode_loader_jap_bz2), 0, 0 };

//-----------------------------------------------------------------------------

static const u8 old_lecode_loader_kor_bz2[] =
{
  // decompressed len: 0x200 = 512 bytes
  0x00,0x00,0x02,0x00,
...
static BZ2Manager_t old_lecode_loader_kor_mgr
	= { old_lecode_loader_kor_bz2, sizeof(old_lecode_loader_kor_bz2), 0, 0 };

//-----------------------------------------------------------------------------

static BZ2Manager_t * GetOldLecodeLoader ( str_mode_t mode )
{
    switch (mode)
    {
...
static const u8 lecode_loader_pal_bz2[] = // lecode-loader-pal.bin
{
  // decompressed size: 0x210 = 528 bytes
  0x00,0x00,0x02,0x10,

  // bzipped data
  ,
  // 0x1f5 = 501 data bytes (96%)
};
...
static const u8 lecode_loader_usa_bz2[] = // lecode-loader-usa.bin
{
  // decompressed size: 0x210 = 528 bytes
  0x00,0x00,0x02,0x10,

  // bzipped data
  ,
  // 0x1f8 = 504 data bytes (96%)
};
...
static const u8 lecode_loader_jap_bz2[] = // lecode-loader-jap.bin
{
  // decompressed size: 0x210 = 528 bytes
  0x00,0x00,0x02,0x10,

  // bzipped data
  ,
  // 0x1f4 = 500 data bytes (95%)
};
...
static const u8 lecode_loader_kor_bz2[] = // lecode-loader-kor.bin
{
  // decompressed size: 0x210 = 528 bytes
  0x00,0x00,0x02,0x10,

  // bzipped data
  ,
  // 0x1f1 = 497 data bytes (95%)
};
	...
	( staticr_t *str, ccp fname, u8 **data, uint *size, bool *alloced )
{
    ...
    *alloced = false;
	...
	else if (!strcmp(fname,"@OLDLECODE"))	wcm = GetOldLecodeLoader(str->mode);
...
const data_tab_t maindol_data_tab[] =
{
 ...
 #if HAVE_WIIMM_EXT
	DEF_BZIP(old_lecode_loader_pal)
	DEF_BZIP(old_lecode_loader_usa)
	DEF_BZIP(old_lecode_loader_jap)
	DEF_BZIP(old_lecode_loader_kor)
